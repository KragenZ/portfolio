# 🚀 Stunning Interactive AI Portfolio

> A modern, blazing-fast, and highly interactive personal portfolio tailored for Artificial Intelligence and Machine Learning engineers.
...
3. *Alternatively*, if you wish to run it on a local server:
   ```bash
...
Created by **Srijit Kumar Roy**
- **GitHub:** [@KragenZ](https://github.com/KragenZ)
- **LinkedIn:** [Srijit Roy](https://www.linkedin.com/in/srijit-roy-7840043b8/)
